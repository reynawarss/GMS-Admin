        ...
        <div class="row">
            ...
            <div class="card"> <!-- Card Start -->
                ...
                <div class="card-body"> <!-- Card Body Start-->
                    <form role="form" action="{{URL::to('/update-blog/'.$edit->id)}}" method="post">
                        @csrf
                        <div class="form-group row">
                            <label for="title" class="col-sm-2 col-form-label">Title</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="title" placeholder="Edit Your Blog Title" value="{{$edit->title}}">
                            </div>
                        </div>
